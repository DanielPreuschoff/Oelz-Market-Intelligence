...
export const FUTURE_FOOD: RadarTafel = {
  ...
  "eintraege": [
    ...
    },
    {
      ...
      "beschreibung": "Massentierhaltung ist ein maßgeblicher Treiber der Klimakrise. Alternativen zur herkömmlichen Fleischproduktion müssen also her - der 3D-Drucker könnte Abhilfe verschaffen. Lebensmittel aus dem Labor, Fleisch aus Ersatzprodukten, Steaks aus dem 3D-Drucker - das Essen der Zukunft ist ein großes Thema für die Forschung. Auch in Tschechien. Dort wird noch deutlich mehr Fleisch gegessen als in Deutschland, aber auch vegetarische Alternativen werden immer beliebter. Besonders, wenn sie gesünder, umweltfreundlicher und günstiger sind. Genau daran arbeiten Forscher in Prag und zwar ganz tschechisch-pragmatisch. Ihre Burger-Paste zum Selbstausdrucken enthält etwas Fleisch. Dadurch bietet sie bei Geschmack, Geruch und Textur deutlich mehr als die meisten Ersatzprodukte, finden die Wissenschaftler. Ein Burger entsteht Tropfen für Tropfen\n\nStepan Janoud ist eigentlich Experte für das natürliche Konservieren von Fleisch. Doch seit einiger Zeit entwickelt der Forscher an der Prager Universität für Chemie und Technologie Lebensmittelmischungen für 3D-Drucker. In einen speziellen Aufsatz, den Spritzen-Extruder, füllt er eine braune Flüssigkeit. \"Das ist eine Paste aus Erbsenprotein, Öl und Leberpastete, unsere alternative Fleischmischung, die wir weiterentwickeln\", erklärt Janoud. Das Geräusch klingt eher nach einem alten Drucker als nach Küche. Aber nach ein paar Minuten zieht ein typischer Fleischgeruch durch das Labor und ein rundes Stück Fleisch für einen Burger entsteht Tropfen für Tropfen auf dem Untersatz. \"Wir waren mit unseren haltbaren Fleischpatronen zum Ausdrucken schon auf einigen Konferenzen\", erzählt Janoud. \"Das Interesse war groß, weil das Thema attraktiv ist.\"\n\nSuche nach dem heiligen Gral\n\nWeltweit wird viel an Fleischalternativen geforscht. Der Markt wächst schnell, selbst im Fleischland Tschechien. Hersteller versprechen günstigere, gesündere und umweltfreundlichere Lebensmittel. Die Entwicklung des perfekten Fleischersatzes gleicht der Suche nach dem heiligen Gral. \"Wir haben mit einem Unternehmen zusammengearbeitet, das Labor-Fleisch züchtet und es beraten\", merkt Janoud an. \"Wir haben auch damit experimentiert, ob man künstliches Fleisch ausdrucken kann und haben das mit natürlichem Hühnerfleisch kombiniert, um so bessere Fleischalternativen herzustellen.\"\n\nDie Textur ist das A und O\n\nBisher sind viele Produkte teuer und alles andere als gesund. Sie enthalten oft wenig Protein, dafür viele hochverarbeitete Zusätze. Die Prager Forscher rund um Professor Rudolf Sevcik nutzen daher nur natürliche Zutaten, und zwar nicht als Pulver, sondern als Paste aus Hülsenfrüchten, Getreide und etwas Fleisch. \"Ich bin schon älter, ich mag keine Revolutionen, aber ich denke, wir sollten uns daran gewöhnen, weniger Fleisch zu essen\" meint Sevcik. \"Einige Nährstoffe nehmen wir jedoch besser aus Fleisch auf. Und wir brauchen es auch, damit es gut schmeckt.\"\n\nDie Prager Universität entwickelt außerdem hybride Brotaufstriche für tschechische Unternehmen. Auf das Ausdrucken des Fleisches setzt sie wegen der Konsistenz. \"Wir sehen, dass der 3D-Druck den fleischlosen oder hybriden Alternativen das geben kann, was ihnen vor allem fehlt: nämlich die Textur. Die stört bisher, wenn man wirklich in etwas reinbeißen will, das an Fleisch erinnert.\"\n\nWird der Drucker zur Heimküche? Die Prager Forscher wollen ihre Technologie zum Selbstausdrucken so verbessern, dass nicht nur Unternehmen interessiert sind, sondern auch Verbraucherinnen und Verbraucher. \"Einige Männer, die sich zum Beispiel mit Modellbau beschäftigen, haben schon heute einen 3D-Drucker zu Hause\" sagt Sevcik. \"Irgendwann bringt die Frau ein Blech in die Werkstatt und unsere Füllung und sagt: Druck mir ein paar Hamburger aus für den Abend. Das ist meine Vision für die Zukunft.“",
      "sektor": "Additive Manufacturing",
      "ebene": "signal",
      "groesse": "m",
      "winkel": 133.19,
    ...
    },
    {
      ...
      "beschreibung": "Bereiten Sie sich auf einen Wettstreit der intelligenten Kühlschränke auf der CES 2020 vor, denn Samsung und LG werden in diesem Jahr Kühlschränke mit erweiterten KI-Funktionen vorstellen. Die neueste Ausgabe von Samsungs Family Hub Kühlschrank und LGs zweite Generation des InstaView ThinQ Kühlschranks verfügen beide über mit KI ausgestattete Kameras, die Lebensmittel identifizieren können. Die Idee ist, dass die Kameras den Inhalt scannen und den Nutzern mitteilen, welche Artikel ihnen fehlen, und sogar Essensvorschläge basierend auf den Zutaten machen, die sie noch haben. Samsungs Family Hub Smart Kühlschrank wurde erstmals auf der CES 2016 vorgestellt, und seitdem hat das Unternehmen aktualisierte Versionen mit Bixby-Unterstützung, SmartThings-Integration und AKG-Lautsprechern herausgebracht. Die neueste Ausgabe fügt Software-Updates hinzu, um die KI-Bilderkennung in den View Inside-Kameras zu ermöglichen. Welcher Kühlschrank wird am Ende übrig bleiben? Früher ermöglichten die Kameras den Nutzern, von ihren Smartphones aus zu sehen, was sich in ihren Kühlschränken befindet, eine nützliche Funktion, wenn man gerade Lebensmittel einkauft und sich nicht erinnern kann, was man nachkaufen muss. Mit den KI-gestützten Updates wird der Family Hub angeblich diese Empfehlungen selbstständig abgeben und identifizieren, bei welchen Zutaten man im Mangel ist. Es bleibt jedoch abzuwarten, wie gut die Bilderkennung funktioniert – zum Beispiel, wie wird sie mit Zutaten umgehen, die in Tupperware aufbewahrt werden? Die Software-Updates beinhalten auch eine verbesserte Essensplanung mit Hilfe von Whisk, einem Food-Tech-Startup, das Samsung letztes Jahr übernommen hat. Whisk ermöglicht es den Nutzern, Mahlzeiten für bis zu eine Woche zu planen und dann intelligente Einkaufslisten zu erstellen, die Zutaten enthalten, die für mehrere Rezepte gelten. Schließlich kann der große integrierte Touchscreen, der als virtuelles schwarzes Brett genutzt werden kann, jetzt auch Videoclips unterstützen sowie Inhalte von Samsung-Fernsehern und -Handys spiegeln. Das bedeutet, dass Sie vertikale Videos wie IGTV auf Ihrem Samsung Kühlschrank ansehen können, wie es sich gehört. LG präsentiert zwei Modelle seiner InstaView Kühlschränke, die beide über ein 22-Zoll-Display verfügen, das transparent werden kann, damit die Nutzer sehen können, was sich im Inneren befindet, ohne die Tür zu öffnen und die kalte Luft entweichen zu lassen. Es gibt den KI-ausgestatteten InstaView ThinQ und den InstaView mit Craft Ice, der schicke, zwei Zoll große Kugeln aus Eis herstellt. Diese sollen langsamer schmelzen als normales Eis, falls das ein Problem für Sie darstellt. Der InstaView mit Craft Ice wurde letztes Jahr in den USA veröffentlicht, wird jetzt aber in weiteren Märkten erhältlich sein. Es gibt noch keine Preisinformationen, aber basierend auf den Preisen der vorherigen Kühlschrankmodelle von LG und Samsung können die Kunden mit Preisen zwischen 4.500 und 6.000 US-Dollar rechnen. Samsung sagt, dass die Updates für den Family Hub im Frühling verfügbar sein werden. Ich bin der Idee eines großen, WLAN-verbundenen Touchscreens auf einem Kühlschrank nicht abgeneigt – tatsächlich scheint es eine wirklich nützliche Möglichkeit zu sein, Rezepte nachzuschlagen oder süße Fotos und Videos anzuzeigen. Ich bin skeptisch, wie gut die KI verschiedene Zutaten identifizieren wird und ob es wirklich besser ist, einen Computer zu nutzen, um zu sehen, welche Artikel man benötigt, als einfach selbst einen Blick hineinzuwerfen.",
      "sektor": "Digitalisation/AI",
      "ebene": "signal",
      "groesse": "s",
      "winkel": 174.94,
    ...
    },
    {
      ...
      "beschreibung": "Aufgrund der wachsenden Bevölkerung wird der Fleischkonsum in Zukunft weiterhin stetig zunehmen. Gleichzeitig werden Ressourcenschonung, Umweltverträglichkeit und die Vermeidung sozialer Ungerechtigkeiten beim Lebensmittelkauf für die Verbraucher immer wichtiger. Das Clean Meat könnte eine Alternative dazu werden: Fleisch, das künstlich im Labor produziert wird. Zahlreiche Wissenschaftler arbeiten bereits an der Herstellung von Fleisch, das im Reagenzglas aus Stammzellen von Rindern, Schweinen oder Hühnern gewonnen wird. Darüber hinaus werden Insekten als effiziente, nahrhafte und umweltfreundliche Proteinquelle als wichtige Zutat in der zukünftigen Ernährung diskutiert.",
      "sektor": "Alternative Proteins",
      "ebene": "cluster",
      "groesse": "m",
      "winkel": 115.17,
    ...
    },
    {
      ...
      "beschreibung": "Lernen Sie Enzymofit kennen\n\nOhne die Notwendigkeit von Zusatzstoffen und aufwendiger Verarbeitung hilft Enzymofit Produzenten, den Hunger der Verbraucher nach umweltfreundlicheren, saubereren und qualitativ hochwertigen Alternativfleischprodukten zu stillen, indem es sensorische Eigenschaften liefert, die dem Original ähneln. Verwandeln Sie Lebensmittel von \"genießbar\" zu lecker\nund nachhaltig nahrhafter! Was tun wir? Wir helfen pflanzenbasierten Produkten,\n\nTierprodukte besser nachzuahmen, indem wir maßgeschneiderte\nBiokatalysatorlösungen in die Produktion einführen. Herausforderungen bei idealen pflanzenbasierten Analogprodukten angehen\n\nEigene Biokatalysatorlösungen für:\n\nAlternative Proteine\n\nVerbesserte \"Fleischigkeit\", Struktur, Bindung, Verdickung und andere Eigenschaften in Fleisch-, Fisch- und Eiersubstituten\n\nTierähnliche Fette\n\nPflanzenbasierte Fette, die sich wie tierische Fette verhalten, mit überlegener Konsistenz, Heizverhalten und Schmelzeigenschaften\n\nKomplexe Zucker\n\nClean Label-Kohlenhydrate, Fasern, Gummis und andere biofunktionale Alternativzutaten mit Eigenschaften, die typischerweise tierischen Produkten eigen sind\n\nGründer und Führungsteam\n\nWir würden uns freuen, von Ihnen zu hören! Hallo",
      "sektor": "Alternative Proteins",
      "ebene": "signal",
      "groesse": "s",
      "winkel": 108.92,
    ...
    },
    {
      ...
      "beschreibung": "Neben der frühen Identifizierung von Krankheiten überwacht die neue Technologie positive Verbesserungen im Verhalten von Kühen und schlägt Möglichkeiten vor, um das Komfortniveau zu erhöhen und Krankheiten zu mildern. Kameras auf den Farmen erzeugen 24-Stunden-Einblicke und Analysen, die informiertere Entscheidungen im Management der Tiere ermöglichen. Der Einzelhändler hat in den letzten Jahren mehrere Millionen Pfund in seine Milchbauern investiert, einschließlich eines fortlaufenden jährlichen Investments von 6 Millionen Pfund in Löhne und Nachhaltigkeitsboni.*\n\nSainsbury’s ist der erste Einzelhändler der Welt, der in neue KI-Veterinärtechnologie investiert, die zur Messung und Verbesserung des positiven Tierschutzes auf Milchfarmen eingesetzt wird und die Herangehensweise an die Rinderpflege revolutionieren könnte. In Partnerschaft mit Vet Vision AI, einem neuen Spin-off-Unternehmen der Universität Nottingham, testet Sainsbury’s eine neue Technologie, die entwickelt wurde, um zu erkennen, wann Kühe glücklich und gesund sind und warum. Die Kühe werden durch kostengünstige und tragbare Kameras überwacht, die von Tierärzten auf mehreren Farmen eingesetzt werden können. Die KI funktioniert, indem sie Verhaltensmuster erkennt, analysiert und Videomaterial in Echtzeit in präzise Daten umwandelt. Neben der Verhaltensüberwachung bietet die KI den Landwirten Vorschläge zur weiteren Verbesserung des Lebensstils der Tiere. Beispiele hierfür sind Verbesserungen der Unterbringung für mehr Komfort und Tierengagement sowie die Bereitstellung von Bereicherungen wie Kuhbürsten, ähnlich einem Rückenkratzer, um Stress zu reduzieren. Die Möglichkeit der 24-Stunden-Überwachung ermöglicht informiertere Entscheidungen, da Landwirte einzigartige Einblicke in das Wohlergehen der Kühe erhalten, die sie möglicherweise bei herkömmlichen Tierarztbesuchen nicht identifizieren können. Die kontinuierliche Analyse des Verhaltens ermöglicht auch einen „Test- und Lern“-Ansatz für die vorgeschlagenen Tierschutzmaßnahmen. Die Nutzung von KI auf Farmen ist ein wachsendes Gebiet, aber was diese Technologie auszeichnet, ist die Fähigkeit zu zeigen, wann eine Kuh gedeiht, anstatt nur Krankheiten und Beschwerden zu erkennen. Die ständige Überwachung kann auch Krankheiten frühzeitig identifizieren, wodurch Tierärzte später keine Behandlungen mehr durchführen müssen. Über die Vorteile für das Tier hinaus fördert die Technologie einen Schritt in Richtung Effizienz in der Landwirtschaft, da eine gesunde Kuh eine produktivere Kuh bedeutet. Wenn die KI beispielsweise empfiehlt, den Komfort der Kühe durch erhöhte Liegezeiten zu verbessern, könnte dies zu einer besseren Bein-Gesundheit und mehr Milchproduktion bei der gleichen Menge Futter führen, da die Kuh stärker auf ihren Klauen ist. Derzeit wird die Technologie auf 30 Farmen der Dairy Development Group von Sainsbury’s eingesetzt, mit dem Ziel, sie im nächsten Jahr weiter auszurollen. Die SDDG wurde 2007 gegründet, um den Landwirten mehr Unterstützung zu bieten. Sie umfasst etwa 170 Farmen, die Sainsbury’s mit eigener Markenmilch beliefern. Dr. Matt Turner, Tierarzt und Landwirtschaftsmanager bei Sainsbury’s, sagte: „In britische Landwirtschaft zu investieren und die Gesundheit und das Wohlbefinden der Tiere kontinuierlich zu verbessern, sind unsere wichtigsten Prioritäten, und diese innovative neue Technologie wird es uns ermöglichen, sowohl Landwirten als auch Tieren zu helfen. „Unsere Milchbauern, die die Technologie nutzen, sehen bereits echte Vorteile, und wir freuen uns darauf, sie bald auf unser größeres Netzwerk von Dairy Development Group-Farmen auszuweiten.“\n\nDr. Tom Angel, Tierarzt bei Synergy Farm Health, sagte: „Vet Vision AI hat es uns ermöglicht, positives Tierwohl auf Farmen zu identifizieren, wie z.B. erhöhte Liegezeiten und den Komfort der Kühe, sowie Managementfaktoren, die angegangen werden müssen, um diese Ergebnisse zu verbessern. Der Einsatz der Computer Vision-Technologie hat es dann ermöglicht, die Auswirkungen von Änderungen, die wir umgesetzt haben, objektiv zu bewerten und zu zeigen, wie die Tiere positiv auf die Umwelt- und Managementänderungen reagiert haben.“\n\nDr. James Breen, Professor für Rindergesundheit an der Universität Nottingham, sagte: „Ich habe begonnen, diese KI-Technologie bei Milchviehgesundheitskunden im Rahmen unserer routinemäßigen Überwachung von Gesundheit und Wohlbefinden zu verwenden. Die Fähigkeit des Systems, das natürliche Verhalten der Kühe zu beobachten, ohne die Tiere zu stören, und diese Beobachtungen in harte Ergebnisse umzuwandeln, ist von großem Wert bei der Planung von Interventionen zur Verbesserung der Fußgesundheit, der Euter-Gesundheit, der Fruchtbarkeitsleistung usw.“\n\nDave Bacon, Milchbauer auf Gleadthorpe Farm, sagte: „Ich weiß, dass glückliche, komfortable Kühe mehr Milch produzieren, aber das genaue Messen und Wissen, wie man den Komfort der Kühe verbessern kann, kann herausfordernd sein. Mit Vet Vision AI konnten wir messen, wie sich die Komfortniveaus verbesserten, nachdem wir unsere Unterbringung aufgerüstet und neue Kuhmatratzen eingelegt hatten. Zu wissen, dass meine Kühe dadurch komfortabler sind, gibt mir das Vertrauen, dass die Investition sich gelohnt hat.“\n\nDiese Initiative ist das neueste Beispiel dafür, wie Sainsbury’s britische Landwirte unterstützt. Für weitere Informationen besuchen Sie: https://www.about.sainsburys.co.uk/sustainability/better-for-the-planet/agriculture. Ende\n\nHinweise für Redakteure\n\n* Sainsbury’s investiert jährlich zusätzlich 6 Millionen Pfund in seine Milchbauern und fördert langfristige Unterstützung für die Branche | Sainsbury's (sainsburys.co.uk)",
      "sektor": "Digitalisation/AI",
      "ebene": "cluster",
      "groesse": "m",
      "winkel": 167.15,
    ...
    },
    {
      ...
      "beschreibung": "Die Neuigkeit ist, dass TOP aus Wageningen in den Niederlanden eine neue Möglichkeit für unternehmerische Milchbauern eingeführt hat: die Pasteurisierung und Verpackung von Milch von einzelnen Kühen. Dies scheint ein weiteres Element zu sein, um ein Kundenerlebnis durch Personalisierung zu bieten. Ein Milchverbraucher könnte denken, dass eine bestimmte Kuh die schmackhafteste Milch liefert, und diese dann direkt bestellen. Ähnlich wie die Snickers-Riegel mit lustigen Worten darauf, bietet es dem Verbraucher die Möglichkeit, das Produkt zu kaufen, das am direktesten zu ihm spricht, während er gleichzeitig seine geliebten Leckereien genießt. Es gibt also die Möglichkeit, Kunden durch Neuheitswert zu gewinnen und sie dann durch Qualitätsprodukte zu halten. Auch Marmite hat diese Idee aufgegriffen, ebenso wie Coca-Cola. Tatsächlich hat die Personalisierung die Softdrink-Industrie erreicht, und Millennials kaufen Erlebnisse, die für sie von Bedeutung sind. Und was könnte mehr bedeuten, als Milch zu trinken, die an einem bestimmten Tag von einer einzelnen Kuh produziert wurde? In einer Welt, in der es mehr anonyme Erfahrungen mit massenproduzierten Produkten gibt, ist der Trend der Verbraucher, eine personalisierte, maßgeschneiderte Erfahrung zu suchen, größer denn je. Milchverarbeiter, insbesondere solche mit kleineren geografischen Gebieten, können diese Erfahrungen bieten. Ich freue mich darauf, bald meine Milch von Elsie der Kuh zu trinken. Verwandte Inhalte",
      "sektor": "Personalisation",
      "ebene": "trend",
      "groesse": "s",
      "winkel": 63.34,
    ...
    },
    {
      ...
      "beschreibung": "5. Biologisch abbaubare Milchflaschen\n\nEin österreichisches Unternehmen \"Naku - Made of Natural Plastic\" hat einen Bioplastikbehälter für Milchprodukte auf den Markt gebracht. Er besteht aus Milchsäure, die aus pflanzlichem Zucker und Stärke gewonnen wird. Die Verpackung ist frei von synthetischen Weichmachern, 20 Mal leichter als Glas und 10 Mal günstiger als Plastik. Sie ist vollständig biologisch abbaubar. Bildnachweis: NaKu",
